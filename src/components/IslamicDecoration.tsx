const IslamicDecoration = () => (
  <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
    ...
    <svg className="absolute top-0 left-0 w-28 h-28 text-primary/[0.08] dark:text-primary/[0.06]" viewBox="0 0 100 100">
    ...
    <svg className="absolute top-0 right-0 w-28 h-28 text-primary/[0.08] dark:text-primary/[0.06] scale-x-[-1]" viewBox="0 0 100 100">
      <path d="M0 0 L50 0 L50 8 L8 8 L8 50 L0 50 Z" fill="currentColor" />
      <path d="M0 0 L28 0 L28 4 L4 4 L4 28 L0 28 Z" fill="currentColor" opacity="0.6" />
    </svg>
    <svg className="absolute bottom-0 left-0 w-28 h-28 text-primary/[0.08] dark:text-primary/[0.06] scale-y-[-1]" viewBox="0 0 100 100">
      <path d="M0 0 L50 0 L50 8 L8 8 L8 50 L0 50 Z" fill="currentColor" />
    </svg>
    <svg className="absolute bottom-0 right-0 w-28 h-28 text-primary/[0.08] dark:text-primary/[0.06] scale-[-1]" viewBox="0 0 100 100">
      <path d="M0 0 L50 0 L50 8 L8 8 L8 50 L0 50 Z" fill="currentColor" />
    </svg>

    {/* Gradient orbs */}
    <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-primary/[0.05] dark:bg-primary/[0.07] blur-[150px]" />
    <div className="absolute bottom-20 right-0 w-80 h-80 rounded-full bg-secondary/[0.04] dark:bg-secondary/[0.05] blur-[120px]" />
    <div className="absolute top-1/2 left-0 w-60 h-60 rounded-full bg-primary/[0.03] dark:bg-primary/[0.04] blur-[100px]" />

    {/* Mosque silhouette bottom */}
    <svg className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-xl h-16 text-primary/[0.04] dark:text-primary/[0.06]" viewBox="0 0 400 50" preserveAspectRatio="xMidYMax meet">
