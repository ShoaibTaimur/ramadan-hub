...
const DIVISION_OFFSETS: Record<
  Division,
  { sahri: number; fajr: number; iftar: number }
> = {
  ঢাকা: { sahri: 0, fajr: 0, iftar: 0 },
  চট্টগ্রাম: { sahri: -5, fajr: -5, iftar: -5 },
  রাজশাহী: { sahri: 6, fajr: 6, iftar: 6 },
  খুলনা: { sahri: 4, fajr: 4, iftar: 4 },
  বরিশাল: { sahri: 0, fajr: 0, iftar: -1 },
  সিলেট: { sahri: -7, fajr: -7, iftar: -7 },
  রংপুর: { sahri: 5, fajr: 5, iftar: 5 },
  ময়মনসিংহ: { sahri: -1, fajr: -1, iftar: -1 },
};
export const divisionOffsets = DIVISION_OFFSETS;
...
const DHAKA: Division = "ঢাকা";

export function getScheduleForDivision(division: Division) {
  const offset = divisionOffsets[division] ?? divisionOffsets[DHAKA];
